...
class ExhibitorInputWrapper extends StatelessWidget {
  final TextEditingController emailController = TextEditingController();
  final TextEditingController passwordController = TextEditingController();
  ExhibitorInputWrapper({super.key});
        ...
        Container(
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, '/exhibitor_account');
                },
                child: const Text(
                  'Sign up',
                  style: TextStyle(
...
// import 'package:exhibition/screens/button.dart';
// import 'package:exhibition/screens/exhibitor_input_field.dart';
// import 'package:flutter/material.dart';

// class ExhibitorInputWrapper extends StatelessWidget {
//   const ExhibitorInputWrapper({super.key});
...
//               borderRadius: BorderRadius.circular(10)
//             ),
//             child: const ExhibitorInputField(),
//           ),
//           const SizedBox(height: 40,),
//           const Text('forgot',
